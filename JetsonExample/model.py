...
class Model:
    ...
    def __init__(self):
        ...
        engine_file_path = os.path.join(current_folder_path, "highstakes_lite.trt")  # This should match the .onnx file name
    ...
    def inference(self, inputImage):
        ...
        postprocessor_args = {
            ...
            "obj_threshold": [0.5, 0.50, 0.50],  # Different thresholds for each class label (Green, Red, Blue)
            "nms_threshold": 0.5,
